...
- +4 years of experience working on similar environments: startup early stage, operations role, dealing with complex systems.

- Experience in any programming language is not important, 

- but we expect you to adapt and learn on the job.
...
- Excel / BI tool, advance user level
- Understand basic RESTful APIs. You will have a first technical conversation with potential partners to evaluate whether the partnership makes sense.
- Strong problem-solving skills and attention to detail

### 1️⃣ In the first month, you will:
- Meet the whole team
- Learn our product and deeply understand the problem domain
...
- Become the most knowledgeable person on multiple key topics
